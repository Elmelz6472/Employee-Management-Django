...
LOGIN_URL = "/employee_management_dev/login"
...
def register_request(request):
    ...
    return render(
        request=request,
        template_name="employee_management_dev/register.html",
...
def login_request(request):
    ...
    return render(
        request=request,
        template_name="employee_management_dev/login.html",
...
def logout_request(request):
    ...
    return redirect("/employee_management_dev/login")
...
def home(request):
    ...
    return render(
        request,
        "employee_management_dev/home.html",
        {
            "data": data,
...
def submit(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("home")
    return render(request, "employee_management_dev/form.html", {"form": form})
...
def edit_employee(request, employee_id):
    ...
    return render(
        request,
        "employee_management_dev/form.html",
...
def view_employee(request, employee_id):
    ...
    return render(
        request,
        "employee_management_dev/view_employee.html",
        {
...
def home_location(request):
    ...
    return render(
        request,
        "employee_management_dev/location_home.html",
        {
            "dct_info": dct_info,
            "number_employee": number_employee,
            "number_location": number_location,
...
def submit_location(request):
    ...
    return render(request, "employee_management_dev/location_form.html", {"form": form})
...
def edit_location(request, location_id):
    ...
    return render(
        request,
        "employee_management_dev/location_form.html",
...
def view_location(request, location_id):
    ...
    return render(
        request,
        "employee_management_dev/location_view.html",
...
def add_calendar(request, location_id):
    ...
    return render(
        request,
        "employee_management_dev/calendar_hour_form.html",
        {"specific_location": specific_location, "form": form},
    )
...
def edit_hours(request, location_id, calendar_id, employee_id, weekly_calendar_id):
    ...
    return render(
        request,
        "employee_management_dev/weekly_hours_form.html",
        {"specific_location": specific_location, "form": form},
    )
...
def view_general_notes(request):
    ...
    return render(
        request,
        "employee_management_dev/view_general_notes.html",
        {
...
def edit_general_notes(request):
    ...
    return render(
        request,
        "employee_management_dev/general_notes_form.html",
...
def view_logs(request):
    ...
    logs = list(LogEntry.objects.all().order_by("-action_time"))[:5]
    log_count = len(list(logs))

    return render(
        request,
        "employee_management_dev/view_logs.html",
...
def changelog(request):
    ...
    return render(request, "employee_management_dev/changelog.html", {"html": html})
